...
async function main() {
  ...
  await prisma.profile.upsert({
    ...
    create: {
      ...
      shortBio:
        "Electrical & Electronic Engineering background, now working as a Merchandiser in Bangladesh's RMG sector — bringing an engineer's discipline for measuring and systematizing to production execution.",
      objective:
        "Merchandiser at Amantex Limited (Gazipur, Bangladesh) with a background in both Electrical & Electronic Engineering and apparel merchandising, currently pursuing an MBA in Apparel Merchandising & Fashion Management. [Add verified years of experience from /admin/profile — shows as a homepage stat once set.]",
