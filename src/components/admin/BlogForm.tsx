    ...
    <form onSubmit={handleSubmit} className="glass max-w-2xl space-y-4 p-6">
      ...
      <div>
        ...
        <input
          ...
          className={inputCls}
        />
        <p className="mt-1 text-xs text-white/40">Leave blank to use today's date automatically when you publish.</p>
      </div>
      ...
      <details className="rounded-lg bg-white/5 p-3 text-sm text-white/60">
        ...
        <div className="mt-3 space-y-3">
          <p className="text-xs text-white/40">খালি রাখলে ভিজিটর শুধু English দেখবে। পূরণ করলে সাইটে English | বাংলা টগল বাটন দেখাবে। Markdown (যেমন **bold**) এখানেও কাজ করবে।</p>
