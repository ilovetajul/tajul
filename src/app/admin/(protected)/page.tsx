  ...
  return (
    <div>
      ...
      <div className="mb-8 flex flex-wrap gap-2">
        <Link href="/admin/projects/new" className="btn-primary !py-2 text-sm">+ New Project</Link>
        <Link href="/admin/blog/new" className="btn-outline !py-2 text-sm">+ New Post</Link>
        <Link href="/admin/experience" className="btn-outline !py-2 text-sm">+ Add Experience</Link>
        <Link href="/admin/education" className="btn-outline !py-2 text-sm">+ Add Certification</Link>
        <Link href="/admin/media" className="btn-outline !py-2 text-sm">Upload Media</Link>
      </div>
