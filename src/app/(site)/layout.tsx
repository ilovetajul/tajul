...
export async function generateMetadata(): Promise<Metadata> {
  ...
  // Fixes the audit finding: without this, Next.js can't reliably resolve absolute
  // URLs for Open Graph images, which can silently break social share previews.
  ...
  if (settings?.maintenanceMode) {
    return (
      <html lang="en" className={poppins.variable}>
        <body className="flex min-h-screen items-center justify-center bg-dark text-white font-sans">
